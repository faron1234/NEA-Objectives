...
class ObstacleSprite(pygame.sprite.Sprite):
    ...
    # creates line objects using the collision class
    # allows projectile intersection with obstacles
    @classmethod
    ...
    # load files with the name corresponding to obstacle adjacency matrix
    # allows obstacles to be dynamically drawn
    @classmethod
...
class Map:
    ...
    # creates an obstacle at a specific cell in the array
    ...
    def createObstacles(self):
        ...
        # removes corner adjacent cells if sides have no adjacent cells
        # improves efficiency
        for obstacle in self.obstacles:
