...
class Line:
    ...
    def intersection(self, lines, screen):
        ...
        for line in lines:
            ...
            pygame.draw.circle(screen, Colours.red, [xi, yi], 10)
            line.xi1 = xi
            line.yi1 = yi
        ...
        if shortestCollision:
            pygame.draw.circle(screen, Colours.blue, [shortestCollision.xi1, shortestCollision.yi1], 15)
